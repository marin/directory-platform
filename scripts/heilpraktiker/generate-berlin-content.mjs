...
import { computeCategoryStats, computeAreaStats, computeIndicationStats } from "../../src/lib/aggregates/compute.ts";
...
console.log(`Generated Berlin category, area, and ${indicationCount} indication hubs.`);
